...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # I would assume this is done to ensure there is less uncertainty about what the state of that string is.
    # To make sure that when we amend it, we amend the original as well
  end
