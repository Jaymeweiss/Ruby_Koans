...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # It could fail if you matched using characters before the * which are not present
    #
  end
  ...
  # They accept as many characters as possible which are present and take the first match they find
  ...
  #
  # A character class would be used to find a specific set of characters while an alternation would be used to allow for more choices
