...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the first as it appears to me, to be more explicit in saying that the method is being declared on itself as the class and not on the instance
  # The second one might be useful if you were declaring many class methods as it would save you having to include self in every method signature
